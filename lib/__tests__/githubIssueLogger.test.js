...
const githubIssueLogger = require('../index');
console.log(process.env.githubPersonalToken);
console.log(process.env);

describe('Setup Tests', () => {
  it('Set & Get Token', () => {
    expect.assertions(1);
    githubIssueLogger.setToken(process.env.githubPersonalToken);
    return expect(githubIssueLogger.getToken()).toEqual(process.env.githubPersonalToken);
  });
  it('Clear Token', () => {
    expect.assertions(1);
